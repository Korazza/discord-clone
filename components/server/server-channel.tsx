...
import { Lock, Edit, Hash, LucideProps, Mic, Trash, Video } from "lucide-react"
...
const iconMap: Map<ChannelType, React.FC<LucideProps>> = new Map([
...
export const ServerChannel: React.FC<ServerChannelProps> = ({
	...
	const Icon = iconMap.get(channel.type) || (() => null)
